...
namespace MTGDeck.Migrations
{
    ...
    [Migration("20220503033554_Initial2")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MTGDeck.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("MTGDeck.Models.Card", b =>
                {
            ...
            modelBuilder.Entity("MTGDeck.Models.CardDeck", b =>
                {
            ...
            modelBuilder.Entity("MTGDeck.Models.CardDeck", b =>
                {
                    b.HasOne("MTGDeck.Models.Card", "Card")
                        .WithMany("JoinEntities")
                        .HasForeignKey("CardId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MTGDeck.Models.Deck", "Deck")
                        .WithMany("JoinEntities")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("MTGDeck.Models.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
